...
$sql = "SELECT nombre FROM organizacion WHERE id = $id_org";
$result = mysqli_query($con, $sql);
$organizacion = mysqli_fetch_array($result);

?>


<div class="contenedor_form_recibo" id="form_recibo" style="display: none;">
  <form id="formRecibo" action="../php/reg_pre.php" method="post" class="p-4 shadow rounded bg-white">
...
<div class="input-group mb-3">    
    ...
    <input type="text" value="<?=$organizacion['nombre']?>" 
